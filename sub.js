...
(function () {
  ...
  var PROTO_SVG = {
    ...
    awg: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="wifi" gradientUnits="userSpaceOnUse" x1="2" y1="4" x2="22" y2="21"><stop offset="0" stop-color="#1FC8D6"/><stop offset="1" stop-color="#2B7CD3"/></linearGradient></defs><g fill="none" stroke="url(#wifi)" stroke-width="2.15" stroke-linecap="round"><path d="M2.5 8.8a14.5 14.5 0 0 1 19 0"/><path d="M5.7 12.3a9.7 9.7 0 0 1 12.6 0"/><path d="M8.9 15.8a4.8 4.8 0 0 1 6.2 0"/></g><circle cx="12" cy="19.2" r="1.35" fill="url(#wifi)"/></svg>',
    turn: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="plane" gradientUnits="userSpaceOnUse" x1="2" y1="3" x2="22" y2="21"><stop offset="0" stop-color="#1FC8D6"/><stop offset="1" stop-color="#2B7CD3"/></linearGradient></defs><path d="M21.2 15.1 14 12.4V7.1c0-1.6-.9-4.1-2-4.1s-2 2.5-2 4.1v5.3l-7.2 2.7v2l7.2-1.3v3.7L7.6 21v1l4.4-.7 4.4.7v-1L14 19.5v-3.7l7.2 1.3z" fill="url(#plane)"/></svg>'
  };
  var _protoN = 0;
